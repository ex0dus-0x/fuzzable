...
functions = {'ASN1_BIT_STRING_check': Function(type='int', derefcnt=0, name='ASN1_BIT_STRING_check', args=[Argument(type='ASN1_BIT_STRING', derefcnt=1, name='a'), Argument(type='unsigned', derefcnt=1, name='flags'), Argument(type='int', derefcnt=0, name='flags_len')]),
 ...
 'EVP_aes_256_cbc_hmac_sha256': Function(type='EVP_CIPHER', derefcnt=1, name='EVP_aes_256_cbc_hmac_sha256', args=[]),
 ...
 'EVP_aes_256_wrap': Function(type='EVP_CIPHER', derefcnt=1, name='EVP_aes_256_wrap', args=[]),
 ...
 'EVP_des_ede3_wrap': Function(type='EVP_CIPHER', derefcnt=1, name='EVP_des_ede3_wrap', args=[]),
 ...
 'PEM_write_DHxparams': Function(type='int', derefcnt=0, name='PEM_write_DHxparams', args=[Argument(type='FILE', derefcnt=1, name='fp'), Argument(type='DH', derefcnt=1, name='x')]),
 ...
 'PEM_write_bio_DHxparams': Function(type='int', derefcnt=0, name='PEM_write_bio_DHxparams', args=[Argument(type='BIO', derefcnt=1, name='bp'), Argument(type='DH', derefcnt=1, name='x')]),
 ...
 'RSA_OAEP_PARAMS_free': Function(type='void', derefcnt=0, name='RSA_OAEP_PARAMS_free', args=[Argument(type='RSA_OAEP_PARAMS', derefcnt=1, name='a')]),
 'RSA_OAEP_PARAMS_new': Function(type='RSA_OAEP_PARAMS', derefcnt=1, name='RSA_OAEP_PARAMS_new', args=[]),
 ...
 'RSA_padding_add_PKCS1_OAEP_mgf1': Function(type='int', derefcnt=0, name='RSA_padding_add_PKCS1_OAEP_mgf1', args=[Argument(type='unsigned', derefcnt=1, name='to'), Argument(type='int', derefcnt=0, name='tlen'), Argument(type='unsigned', derefcnt=1, name='from'), Argument(type='int', derefcnt=0, name='flen'), Argument(type='unsigned', derefcnt=1, name='param'), Argument(type='int', derefcnt=0, name='plen'), Argument(type='EVP_MD', derefcnt=1, name='md'), Argument(type='EVP_MD', derefcnt=1, name='mgf1md')]),
 ...
 'RSA_padding_check_PKCS1_OAEP_mgf1': Function(type='int', derefcnt=0, name='RSA_padding_check_PKCS1_OAEP_mgf1', args=[Argument(type='unsigned', derefcnt=1, name='to'), Argument(type='int', derefcnt=0, name='tlen'), Argument(type='unsigned', derefcnt=1, name='from'), Argument(type='int', derefcnt=0, name='flen'), Argument(type='int', derefcnt=0, name='num'), Argument(type='unsigned', derefcnt=1, name='param'), Argument(type='int', derefcnt=0, name='plen'), Argument(type='EVP_MD', derefcnt=1, name='md'), Argument(type='EVP_MD', derefcnt=1, name='mgf1md')]),
 ...
 'SSL_CIPHER_find': Function(type='SSL_CIPHER', derefcnt=1, name='SSL_CIPHER_find', args=[Argument(type='SSL', derefcnt=1, name='ssl'), Argument(type='unsigned', derefcnt=1, name='ptr')]),
 ...
 'SSL_COMP_free_compression_methods': Function(type='void', derefcnt=0, name='SSL_COMP_free_compression_methods', args=[]),
 ...
 'SSL_COMP_set0_compression_methods': Function(type='stack_st_SSL_COMP', derefcnt=1, name='SSL_COMP_set0_compression_methods', args=[Argument(type='stack_st_SSL_COMP', derefcnt=1, name='meths')]),
 'SSL_CONF_CTX_clear_flags': Function(type='unsigned', derefcnt=0, name='SSL_CONF_CTX_clear_flags', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx'), Argument(type='unsigned', derefcnt=0, name='flags')]),
 'SSL_CONF_CTX_finish': Function(type='int', derefcnt=0, name='SSL_CONF_CTX_finish', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx')]),
 'SSL_CONF_CTX_free': Function(type='void', derefcnt=0, name='SSL_CONF_CTX_free', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx')]),
 'SSL_CONF_CTX_new': Function(type='SSL_CONF_CTX', derefcnt=1, name='SSL_CONF_CTX_new', args=[]),
 'SSL_CONF_CTX_set1_prefix': Function(type='int', derefcnt=0, name='SSL_CONF_CTX_set1_prefix', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx'), Argument(type='char', derefcnt=1, name='pre')]),
 'SSL_CONF_CTX_set_flags': Function(type='unsigned', derefcnt=0, name='SSL_CONF_CTX_set_flags', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx'), Argument(type='unsigned', derefcnt=0, name='flags')]),
 'SSL_CONF_CTX_set_ssl': Function(type='void', derefcnt=0, name='SSL_CONF_CTX_set_ssl', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx'), Argument(type='SSL', derefcnt=1, name='ssl')]),
 'SSL_CONF_CTX_set_ssl_ctx': Function(type='void', derefcnt=0, name='SSL_CONF_CTX_set_ssl_ctx', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx'), Argument(type='SSL_CTX', derefcnt=1, name='ctx')]),
 'SSL_CONF_cmd': Function(type='int', derefcnt=0, name='SSL_CONF_cmd', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx'), Argument(type='char', derefcnt=1, name='cmd'), Argument(type='char', derefcnt=1, name='value')]),
 'SSL_CONF_cmd_argv': Function(type='int', derefcnt=0, name='SSL_CONF_cmd_argv', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx'), Argument(type='int', derefcnt=1, name='pargc'), Argument(type='char', derefcnt=3, name='pargv')]),
 'SSL_CONF_cmd_value_type': Function(type='int', derefcnt=0, name='SSL_CONF_cmd_value_type', args=[Argument(type='SSL_CONF_CTX', derefcnt=1, name='cctx'), Argument(type='char', derefcnt=1, name='cmd')]),
 ...
 'SSL_CTX_add_client_custom_ext': Function(type='int', derefcnt=0, name='SSL_CTX_add_client_custom_ext', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx'), Argument(type='unsigned', derefcnt=0, name='ext_type'), Argument(type='custom_ext_add_cb', derefcnt=0, name='add_cb'), Argument(type='custom_ext_free_cb', derefcnt=0, name='free_cb'), Argument(type='void', derefcnt=1, name='add_arg'), Argument(type='custom_ext_parse_cb', derefcnt=0, name='parse_cb'), Argument(type='void', derefcnt=1, name='parse_arg')]),
 'SSL_CTX_add_server_custom_ext': Function(type='int', derefcnt=0, name='SSL_CTX_add_server_custom_ext', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx'), Argument(type='unsigned', derefcnt=0, name='ext_type'), Argument(type='custom_ext_add_cb', derefcnt=0, name='add_cb'), Argument(type='custom_ext_free_cb', derefcnt=0, name='free_cb'), Argument(type='void', derefcnt=1, name='add_arg'), Argument(type='custom_ext_parse_cb', derefcnt=0, name='parse_cb'), Argument(type='void', derefcnt=1, name='parse_arg')]),
 ...
 'SSL_CTX_get0_certificate': Function(type='X509', derefcnt=1, name='SSL_CTX_get0_certificate', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx')]),
 'SSL_CTX_get0_param': Function(type='X509_VERIFY_PARAM', derefcnt=1, name='SSL_CTX_get0_param', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx')]),
 'SSL_CTX_get0_privatekey': Function(type='EVP_PKEY', derefcnt=1, name='SSL_CTX_get0_privatekey', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx')]),
 ...
 'SSL_CTX_get_ssl_method': Function(type='SSL_METHOD', derefcnt=1, name='SSL_CTX_get_ssl_method', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx')]),
 ...
 'SSL_CTX_set_alpn_protos': Function(type='int', derefcnt=0, name='SSL_CTX_set_alpn_protos', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx'), Argument(type='unsigned', derefcnt=1, name='protos'), Argument(type='unsigned', derefcnt=0, name='protos_len')]),
 'SSL_CTX_set_alpn_select_cb': Function(type='void', derefcnt=0, name='SSL_CTX_set_alpn_select_cb', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx'), Argument(type='int', derefcnt=0, name='cb'), Argument(type='void', derefcnt=1, name='arg')]),
 'SSL_CTX_set_cert_cb': Function(type='void', derefcnt=0, name='SSL_CTX_set_cert_cb', args=[Argument(type='SSL_CTX', derefcnt=1, name='c'), Argument(type='int', derefcnt=0, name='cb'), Argument(type='void', derefcnt=1, name='arg')]),
 ...
 'SSL_CTX_use_serverinfo': Function(type='int', derefcnt=0, name='SSL_CTX_use_serverinfo', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx'), Argument(type='unsigned', derefcnt=1, name='serverinfo'), Argument(type='size_t', derefcnt=0, name='serverinfo_length')]),
 'SSL_CTX_use_serverinfo_file': Function(type='int', derefcnt=0, name='SSL_CTX_use_serverinfo_file', args=[Argument(type='SSL_CTX', derefcnt=1, name='ctx'), Argument(type='char', derefcnt=1, name='file')]),
 ...
 'SSL_certs_clear': Function(type='void', derefcnt=0, name='SSL_certs_clear', args=[Argument(type='SSL', derefcnt=1, name='s')]),
 'SSL_check_chain': Function(type='int', derefcnt=0, name='SSL_check_chain', args=[Argument(type='SSL', derefcnt=1, name='s'), Argument(type='X509', derefcnt=1, name='x'), Argument(type='EVP_PKEY', derefcnt=1, name='pk'), Argument(type='stack_st_X509', derefcnt=1, name='chain')]),
 ...
 'SSL_extension_supported': Function(type='int', derefcnt=0, name='SSL_extension_supported', args=[Argument(type='unsigned', derefcnt=0, name='ext_type')]),
 'SSL_free': Function(type='void', derefcnt=0, name='SSL_free', args=[Argument(type='SSL', derefcnt=1, name='ssl')]),
 'SSL_get0_alpn_selected': Function(type='void', derefcnt=0, name='SSL_get0_alpn_selected', args=[Argument(type='SSL', derefcnt=1, name='ssl'), Argument(type='unsigned', derefcnt=2, name='data'), Argument(type='unsigned', derefcnt=1, name='len')]),
 ...
 'SSL_get0_param': Function(type='X509_VERIFY_PARAM', derefcnt=1, name='SSL_get0_param', args=[Argument(type='SSL', derefcnt=1, name='ssl')]),
 ...
 'SSL_get_shared_sigalgs': Function(type='int', derefcnt=0, name='SSL_get_shared_sigalgs', args=[Argument(type='SSL', derefcnt=1, name='s'), Argument(type='int', derefcnt=0, name='idx'), Argument(type='int', derefcnt=1, name='psign'), Argument(type='int', derefcnt=1, name='phash'), Argument(type='int', derefcnt=1, name='psignandhash'), Argument(type='unsigned', derefcnt=1, name='rsig'), Argument(type='unsigned', derefcnt=1, name='rhash')]),
 'SSL_get_shutdown': Function(type='int', derefcnt=0, name='SSL_get_shutdown', args=[Argument(type='SSL', derefcnt=1, name='ssl')]),
 'SSL_get_sigalgs': Function(type='int', derefcnt=0, name='SSL_get_sigalgs', args=[Argument(type='SSL', derefcnt=1, name='s'), Argument(type='int', derefcnt=0, name='idx'), Argument(type='int', derefcnt=1, name='psign'), Argument(type='int', derefcnt=1, name='phash'), Argument(type='int', derefcnt=1, name='psignandhash'), Argument(type='unsigned', derefcnt=1, name='rsig'), Argument(type='unsigned', derefcnt=1, name='rhash')]),
 ...
 'SSL_is_server': Function(type='int', derefcnt=0, name='SSL_is_server', args=[Argument(type='SSL', derefcnt=1, name='s')]),
 ...
 'SSL_set_alpn_protos': Function(type='int', derefcnt=0, name='SSL_set_alpn_protos', args=[Argument(type='SSL', derefcnt=1, name='ssl'), Argument(type='unsigned', derefcnt=1, name='protos'), Argument(type='unsigned', derefcnt=0, name='protos_len')]),
 ...
 'SSL_set_cert_cb': Function(type='void', derefcnt=0, name='SSL_set_cert_cb', args=[Argument(type='SSL', derefcnt=1, name='s'), Argument(type='int', derefcnt=0, name='cb'), Argument(type='void', derefcnt=1, name='arg')]),
 ...
 'SSL_test_functions': Function(type='openssl_ssl_test_functions', derefcnt=1, name='SSL_test_functions', args=[]),
 ...
 'X509_CRL_check_suiteb': Function(type='int', derefcnt=0, name='X509_CRL_check_suiteb', args=[Argument(type='X509_CRL', derefcnt=1, name='crl'), Argument(type='EVP_PKEY', derefcnt=1, name='pk'), Argument(type='unsigned', derefcnt=0, name='flags')]),
 ...
 'X509_CRL_diff': Function(type='X509_CRL', derefcnt=1, name='X509_CRL_diff', args=[Argument(type='X509_CRL', derefcnt=1, name='base'), Argument(type='X509_CRL', derefcnt=1, name='newer'), Argument(type='EVP_PKEY', derefcnt=1, name='skey'), Argument(type='EVP_MD', derefcnt=1, name='md'), Argument(type='unsigned', derefcnt=0, name='flags')]),
 ...
 'X509_CRL_http_nbio': Function(type='int', derefcnt=0, name='X509_CRL_http_nbio', args=[Argument(type='OCSP_REQ_CTX', derefcnt=1, name='rctx'), Argument(type='X509_CRL', derefcnt=2, name='pcrl')]),
 ...
 'X509_REVOKED_dup': Function(type='X509_REVOKED', derefcnt=1, name='X509_REVOKED_dup', args=[Argument(type='X509_REVOKED', derefcnt=1, name='rev')]),
 ...
 'X509_STORE_CTX_get0_store': Function(type='X509_STORE', derefcnt=1, name='X509_STORE_CTX_get0_store', args=[Argument(type='X509_STORE_CTX', derefcnt=1, name='ctx')]),
 ...
 'X509_STORE_set_lookup_crls_cb': Function(type='void', derefcnt=0, name='X509_STORE_set_lookup_crls_cb', args=[Argument(type='X509_STORE', derefcnt=1, name='ctx'), Argument(type='stack_st_X509_CRL', derefcnt=1, name='cb')]),
 ...
 'X509_VERIFY_PARAM_add1_host': Function(type='int', derefcnt=0, name='X509_VERIFY_PARAM_add1_host', args=[Argument(type='X509_VERIFY_PARAM', derefcnt=1, name='param'), Argument(type='char', derefcnt=1, name='name'), Argument(type='size_t', derefcnt=0, name='namelen')]),
 ...
 'X509_VERIFY_PARAM_get0': Function(type='X509_VERIFY_PARAM', derefcnt=1, name='X509_VERIFY_PARAM_get0', args=[Argument(type='int', derefcnt=0, name='id')]),
 'X509_VERIFY_PARAM_get0_name': Function(type='char', derefcnt=1, name='X509_VERIFY_PARAM_get0_name', args=[Argument(type='X509_VERIFY_PARAM', derefcnt=1, name='param')]),
 'X509_VERIFY_PARAM_get0_peername': Function(type='char', derefcnt=1, name='X509_VERIFY_PARAM_get0_peername', args=[Argument(type='X509_VERIFY_PARAM', derefcnt=1, name='arg0')]),
 'X509_VERIFY_PARAM_get_count': Function(type='int', derefcnt=0, name='X509_VERIFY_PARAM_get_count', args=[]),
 ...
 'X509_VERIFY_PARAM_set1_email': Function(type='int', derefcnt=0, name='X509_VERIFY_PARAM_set1_email', args=[Argument(type='X509_VERIFY_PARAM', derefcnt=1, name='param'), Argument(type='char', derefcnt=1, name='email'), Argument(type='size_t', derefcnt=0, name='emaillen')]),
 'X509_VERIFY_PARAM_set1_host': Function(type='int', derefcnt=0, name='X509_VERIFY_PARAM_set1_host', args=[Argument(type='X509_VERIFY_PARAM', derefcnt=1, name='param'), Argument(type='char', derefcnt=1, name='name'), Argument(type='size_t', derefcnt=0, name='namelen')]),
 'X509_VERIFY_PARAM_set1_ip': Function(type='int', derefcnt=0, name='X509_VERIFY_PARAM_set1_ip', args=[Argument(type='X509_VERIFY_PARAM', derefcnt=1, name='param'), Argument(type='unsigned', derefcnt=1, name='ip'), Argument(type='size_t', derefcnt=0, name='iplen')]),
 'X509_VERIFY_PARAM_set1_ip_asc': Function(type='int', derefcnt=0, name='X509_VERIFY_PARAM_set1_ip_asc', args=[Argument(type='X509_VERIFY_PARAM', derefcnt=1, name='param'), Argument(type='char', derefcnt=1, name='ipasc')]),
 ...
 'X509_VERIFY_PARAM_set_hostflags': Function(type='void', derefcnt=0, name='X509_VERIFY_PARAM_set_hostflags', args=[Argument(type='X509_VERIFY_PARAM', derefcnt=1, name='param'), Argument(type='unsigned', derefcnt=0, name='flags')]),
 ...
 'X509_chain_check_suiteb': Function(type='int', derefcnt=0, name='X509_chain_check_suiteb', args=[Argument(type='int', derefcnt=1, name='perror_depth'), Argument(type='X509', derefcnt=1, name='x'), Argument(type='stack_st_X509', derefcnt=1, name='chain'), Argument(type='unsigned', derefcnt=0, name='flags')]),
 'X509_chain_up_ref': Function(type='stack_st_X509', derefcnt=1, name='X509_chain_up_ref', args=[Argument(type='stack_st_X509', derefcnt=1, name='chain')]),
 ...
 'X509_get0_signature': Function(type='void', derefcnt=0, name='X509_get0_signature', args=[Argument(type='ASN1_BIT_STRING', derefcnt=2, name='psig'), Argument(type='X509_ALGOR', derefcnt=2, name='palg'), Argument(type='X509', derefcnt=1, name='x')]),
 ...
 'X509_get_signature_nid': Function(type='int', derefcnt=0, name='X509_get_signature_nid', args=[Argument(type='X509', derefcnt=1, name='x')]),
 ...
 'X509_http_nbio': Function(type='int', derefcnt=0, name='X509_http_nbio', args=[Argument(type='OCSP_REQ_CTX', derefcnt=1, name='rctx'), Argument(type='X509', derefcnt=2, name='pcert')]),
 ...
 'clone2': Function(type='int', derefcnt=0, name='clone2', args=[Argument(type='int', derefcnt=0, name='fn'), Argument(type='void', derefcnt=1, name='child_stack_base'), Argument(type='size_t', derefcnt=0, name='stack_size'), Argument(type='int', derefcnt=0, name='flags'), Argument(type='void', derefcnt=1, name='arg'), Argument(type='int', derefcnt=0, name='vararg')]),
 ...
 'custom_ext_add_cb': Function(type='int', derefcnt=0, name='custom_ext_add_cb', args=[Argument(type='SSL', derefcnt=1, name='s'), Argument(type='unsigned', derefcnt=0, name='ext_type'), Argument(type='unsigned', derefcnt=2, name='out'), Argument(type='size_t', derefcnt=1, name='outlen'), Argument(type='int', derefcnt=1, name='al'), Argument(type='void', derefcnt=1, name='add_arg')]),
 'custom_ext_free_cb': Function(type='void', derefcnt=0, name='custom_ext_free_cb', args=[Argument(type='SSL', derefcnt=1, name='s'), Argument(type='unsigned', derefcnt=0, name='ext_type'), Argument(type='unsigned', derefcnt=1, name='out'), Argument(type='void', derefcnt=1, name='add_arg')]),
 'custom_ext_parse_cb': Function(type='int', derefcnt=0, name='custom_ext_parse_cb', args=[Argument(type='SSL', derefcnt=1, name='s'), Argument(type='unsigned', derefcnt=0, name='ext_type'), Argument(type='unsigned', derefcnt=1, name='in'), Argument(type='size_t', derefcnt=0, name='inlen'), Argument(type='int', derefcnt=1, name='al'), Argument(type='void', derefcnt=1, name='parse_arg')]),
 ...
 'd2i_DHxparams': Function(type='DH', derefcnt=1, name='d2i_DHxparams', args=[Argument(type='DH', derefcnt=2, name='a'), Argument(type='unsigned', derefcnt=2, name='pp'), Argument(type='long', derefcnt=0, name='length')]),
 ...
 'd2i_RSA_OAEP_PARAMS': Function(type='RSA_OAEP_PARAMS', derefcnt=1, name='d2i_RSA_OAEP_PARAMS', args=[Argument(type='RSA_OAEP_PARAMS', derefcnt=2, name='a'), Argument(type='unsigned', derefcnt=2, name='in'), Argument(type='long', derefcnt=0, name='len')]),
 ...
 'futex': Function(type='int', derefcnt=0, name='futex', args=[Argument(type='int', derefcnt=1, name='uaddr'), Argument(type='int', derefcnt=0, name='futex_op'), Argument(type='int', derefcnt=0, name='val'), Argument(type='timespec', derefcnt=1, name='timeout'), Argument(type='int', derefcnt=1, name='uaddr2'), Argument(type='int', derefcnt=0, name='val3')]),
 ...
 'get_mempolicy': Function(type='int', derefcnt=0, name='get_mempolicy', args=[Argument(type='int', derefcnt=1, name='mode'), Argument(type='unsigned', derefcnt=1, name='nodemask'), Argument(type='unsigned', derefcnt=0, name='maxnode'), Argument(type='unsigned', derefcnt=0, name='addr'), Argument(type='unsigned', derefcnt=0, name='flags')]),
 ...
 'get_thread_area': Function(type='int', derefcnt=0, name='get_thread_area', args=[Argument(type='user_desc', derefcnt=1, name='u_info')]),
 ...
 'getdents': Function(type='int', derefcnt=0, name='getdents', args=[Argument(type='unsigned', derefcnt=0, name='fd'), Argument(type='linux_dirent', derefcnt=1, name='dirp'), Argument(type='unsigned', derefcnt=0, name='count')]),
 'getdents64': Function(type='int', derefcnt=0, name='getdents64', args=[Argument(type='unsigned', derefcnt=0, name='fd'), Argument(type='linux_dirent64', derefcnt=1, name='dirp'), Argument(type='unsigned', derefcnt=0, name='count')]),
 ...
 'getrandom': Function(type='int', derefcnt=0, name='getrandom', args=[Argument(type='void', derefcnt=1, name='buf'), Argument(type='size_t', derefcnt=0, name='buflen'), Argument(type='unsigned', derefcnt=0, name='flags')]),
 ...
 'i2d_DHxparams': Function(type='int', derefcnt=0, name='i2d_DHxparams', args=[Argument(type='DH', derefcnt=1, name='a'), Argument(type='unsigned', derefcnt=2, name='pp')]),
 ...
 'i2d_RSA_OAEP_PARAMS': Function(type='int', derefcnt=0, name='i2d_RSA_OAEP_PARAMS', args=[Argument(type='RSA_OAEP_PARAMS', derefcnt=1, name='a'), Argument(type='unsigned', derefcnt=2, name='out')]),
 ...
 'i2d_re_X509_tbs': Function(type='int', derefcnt=0, name='i2d_re_X509_tbs', args=[Argument(type='X509', derefcnt=1, name='x'), Argument(type='unsigned', derefcnt=2, name='pp')]),
 ...
 'io_cancel': Function(type='int', derefcnt=0, name='io_cancel', args=[Argument(type='aio_context_t', derefcnt=0, name='ctx_id'), Argument(type='iocb', derefcnt=1, name='iocb'), Argument(type='io_event', derefcnt=1, name='result')]),
 'io_close_fn': Function(type='int', derefcnt=0, name='io_close_fn', args=[Argument(type='void', derefcnt=1, name='cookie')]),
 'io_destroy': Function(type='int', derefcnt=0, name='io_destroy', args=[Argument(type='aio_context_t', derefcnt=0, name='ctx_id')]),
 'io_getevents': Function(type='int', derefcnt=0, name='io_getevents', args=[Argument(type='aio_context_t', derefcnt=0, name='ctx_id'), Argument(type='long', derefcnt=0, name='min_nr'), Argument(type='long', derefcnt=0, name='nr'), Argument(type='io_event', derefcnt=1, name='events'), Argument(type='timespec', derefcnt=1, name='timeout')]),
 ...
 'io_setup': Function(type='int', derefcnt=0, name='io_setup', args=[Argument(type='unsigned', derefcnt=0, name='nr_events'), Argument(type='aio_context_t', derefcnt=1, name='ctx_idp')]),
 'io_submit': Function(type='int', derefcnt=0, name='io_submit', args=[Argument(type='aio_context_t', derefcnt=0, name='ctx_id'), Argument(type='long', derefcnt=0, name='nr'), Argument(type='iocb', derefcnt=2, name='iocbpp')]),
 ...
 'keyctl': Function(type='long', derefcnt=0, name='keyctl', args=[Argument(type='int', derefcnt=0, name='cmd'), Argument(type='int', derefcnt=0, name='vararg')]),
 ...
 'monstartup': Function(type='void', derefcnt=0, name='monstartup', args=[Argument(type='u_long', derefcnt=0, name='lowpc'), Argument(type='u_long', derefcnt=0, name='highpc')]),
 ...
 'request_key': Function(type='key_serial_t', derefcnt=0, name='request_key', args=[Argument(type='char', derefcnt=1, name='type'), Argument(type='char', derefcnt=1, name='description'), Argument(type='char', derefcnt=1, name='callout_info'), Argument(type='key_serial_t', derefcnt=0, name='keyring')]),
 ...
 'rt_sigqueueinfo': Function(type='int', derefcnt=0, name='rt_sigqueueinfo', args=[Argument(type='pid_t', derefcnt=0, name='tgid'), Argument(type='int', derefcnt=0, name='sig'), Argument(type='siginfo_t', derefcnt=1, name='uinfo')]),
 'rt_tgsigqueueinfo': Function(type='int', derefcnt=0, name='rt_tgsigqueueinfo', args=[Argument(type='pid_t', derefcnt=0, name='tgid'), Argument(type='pid_t', derefcnt=0, name='tid'), Argument(type='int', derefcnt=0, name='sig'), Argument(type='siginfo_t', derefcnt=1, name='uinfo')]),
 ...
 'set_thread_area': Function(type='int', derefcnt=0, name='set_thread_area', args=[Argument(type='user_desc', derefcnt=1, name='u_info')]),
 ...
 'sk_deep_copy': Function(type='STACK', derefcnt=1, name='sk_deep_copy', args=[Argument(type='STACK', derefcnt=1, name='arg0'), Argument(type='void', derefcnt=1, name='')]),
